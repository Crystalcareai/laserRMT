...
class ModelModifier:
    ...
    def interactive_select_weights(self):
        ...
        self.layer_types = selected_types  # Save selected types
    ...
    def save_snr_to_json(self):
        ...
        # Sort layers within each type group by SNR value in descending order
        sorted_type_groups = {}
        ...
        # Generate YAML file for the top n% SNR within each type
...
if args.json:
    ...
    modifier = ModelModifier("")  # Empty model name since it's not used when loading from JSON
    modifier.generate_unfrozen_params_yaml(sorted_type_groups, top_percent=50)  # Adjust top_percent as needed
else:
